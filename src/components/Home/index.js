...
function Home() {
    ...
    return (
        ...
        <header className="w3-grayscale-min"
            ...
            <button className="home-button"><a href="#about" className="w3-button w3-white w3-padding-large w3-large w3-margin-top w3-opacity w3-hover-opacity-off">Web Developer</a></button>
